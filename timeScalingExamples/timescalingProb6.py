...
trajectoryQ = JointTrajectory(theta0,thetaf,1.0,101,scaleMethod="Quintic")
trajectoryC = JointTrajectory(theta0,thetaf,1.0,101,scaleMethod="Cubic")
thetalistQ = [i[1] for i in trajectoryQ]
thetalistC = [i[1] for i in trajectoryC]
t = np.arange(0.0,1.0, 1.0/(101))
